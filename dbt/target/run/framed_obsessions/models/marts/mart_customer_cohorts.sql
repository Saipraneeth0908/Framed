  ...
  create  table "framedobsessions"."mart"."mart_customer_cohorts__dbt_tmp"
...
from "framedobsessions"."stg"."stg_customers" c
left join "framedobsessions"."stg"."stg_orders" o on o.customer_id = c.customer_id
group by 1
  );
